...
class GAStoragePlugin(GAPlugin):
    ...
    def instantiate(self, resource_name): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s should implement instantiate method" % self)

    def count(self, parent, resource_name, filter=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement count method" % self)

    def get(self, resource_name, identifier=None, filter=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement get method" % self)

    def get_all(self, parent, resource_name, page=None, page_size=None, filter=None, order_by=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement get_all method" % self)

    def create(self, resource, parent=None, user_identifier=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement create method" % self)

    def update(self, resource, user_identifier=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement update method" % self)

    def delete(self, resource, cascade=True, user_identifier=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement delete method" % self)

    def delete_multiple(self, resources, cascade=True, user_identifier=None): # pragma: no cover
        """
        """
        raise NotImplementedErrorError("%s must implement delete_multiple method" % self)

    def assign(self, resource_name, resources, parent, user_identifier=None): # pragma: no cover
        """
        """
