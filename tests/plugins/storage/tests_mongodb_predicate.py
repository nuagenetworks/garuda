...
class TestGAMongoPredicateConverter(TestCase):
    ...
    def test_strings(self):
        """
        """
        self.assertConvertEquals('name = Christophe', {'name': {'$eq': 'Christophe'}})
    ...
    def test_constants(self):
        """
        """
        self.assertConvertEquals('defaultValue is null', {'defaultValue': {'$eq': 'null'}})

        self.assertConvertEquals('defaultValue is undefined', {'defaultValue': {'$eq': 'null'}})

        self.assertConvertEquals('defaultValue is empty', {'defaultValue': {'$eq': ''}})
    ...
    def test_operator_not_equal(self):
        """
        """
        self.assertConvertEquals('name != Christophe', {'name': {'$ne': 'Christophe'}})

        self.assertConvertEquals('name is not Christophe', {'name': {'$ne': 'Christophe'}})
    ...
    def test_operator_equal(self):
        ...
        self.assertConvertEquals("name is Christophe", {'name': {'$eq': 'Christophe'}})
    ...
    def test_search_contains(self):
        """
        """
        self.assertConvertEquals('name contains Chris', {'name': {'$regex': 'Chris', '$options': 'i'}})
        self.assertConvertEquals('name CONTAINS Chris', {'name': {'$regex': 'Chris', '$options': 'i'}})
